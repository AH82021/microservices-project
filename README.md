catalog-service: This services provides REST API for managing catalog of products.
...
UI: This is the customer facing web application where customers can browse the catalog, place orders, and view their order details.
